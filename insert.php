...
mysqli_query($con, "INSERT INTO comments(email, comments) VALUES('".$_SESSION['username']."','$comments')");
$result = mysqli_query($con, "SELECT * FROM comments WHERE email = '".$_SESSION['username']."' order by date_publish desc"); // comments
$result2 = mysqli_query($con, "SELECT * FROM users WHERE email = '".$_SESSION['username']."'"); // users
